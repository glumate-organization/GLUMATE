...
export const credentials: Credential[] = [
  {
    ...
    kind: 'Partnership',
    name: '㈜아이센스',
    title: '연속혈당측정 데이터를 정식 연동합니다',
    body: '케어센스 에어(CareSens Air)를 만드는 ㈜아이센스와 개발 파트너십을 맺고, 센서가 잰 값을 공식 경로로 받아 처리합니다. 우회 수집이 아닌 제조사와 합의된 연동입니다.',
    meta: '개발 파트너십 체결',
  },
  {
    key: 'startup-academy',
    kind: 'Selected',
    name: '청년창업사관학교 16기',
    title: '기술성과 사업성을 외부에서 검증받았습니다',
    body: '중소벤처기업진흥공단이 운영하는 청년창업사관학교 16기에 선정되어, 제품과 기술을 다듬는 과정을 함께하고 있습니다.',
    meta: '중소벤처기업진흥공단',
  },
];
